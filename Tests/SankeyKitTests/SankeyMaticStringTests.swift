...
@Test func financialResults() async throws {
    ...
    #expect(sankey.flows[5].value == .double(10))
    ...
    #expect(sankey.flows[6].value == .double(640))
    ...
    #expect(sankey.flows[7].value == .double(350))
